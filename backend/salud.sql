...
CREATE TABLE `control` (
  ...
  CONSTRAINT `fk_control_usuario` FOREIGN KEY (`usuario_idusuario`) REFERENCES `usuario` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2022-03-23  2:45:50
